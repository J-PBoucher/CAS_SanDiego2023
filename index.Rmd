...
Based on the baysian model, by fitting a Negative Binomial distribution (NB2) on claim counts data, we know that the heterogeneity of our portfolio $\Theta$ is following a gamma( $\alpha = 2.1244$, $\tau = \alpha = 2.1244$).
...
$\alpha$ is not the same ($\widehat{\beta}$ are also different).
...
The problem with the last approach is that it cannot differentiate new insureds from insureds with many years of experience: both types of insureds have $n_{i, \bullet} = 0$. 
...
3) Each claim increases the claim score by $\Psi = \frac{\widehat{\gamma_2}}{\widehat{\gamma_1}} = 3.93$, called the *jump-parameter*:  
  ...
  - $\Psi = \frac{\gamma_2}{\gamma_1}= \frac{0.1976}{0.1101} = 1.79$ for the fictive car insurance dataset.
